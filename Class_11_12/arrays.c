...
int main()
 ...
 printf("\nprogrametaja pasargasana no logiskas kludas\n");
 int N_Bytes = sizeof(i_array_2);
 printf("i_array_2 masiva izmers baitos: %d\n", N_Bytes);
 ...
 int i; 
 for(i=0; i<N; i++){
 printf("masiva i_array_2 %d. elementa adrese: %p\n", i, &i_array_2[i]);
 printf("masiva i_array_2 %d. elementa vertiba: %d\n", i, i_array_2[i]);
 printf("masiva i_array_2 %d. elementa vertiba: %d\n", i, *(i_array_2+i));
 }
